...
public class ValueCompareExample {
	public static void main(String[] args) {
		//Wrapper 객체 내부의 값을 비교할 때는 == 을 사용 하지 않는게 좋음
		//언박싱 한 값으로 비교하거나 , equlas() 메소드를 사용
		System.out.println("[-128~127 초과값일 경우]");
		Integer obj1 = 300;//자동 박싱
		Integer obj2 = 300;//자동 박싱
		System.out.println("==결과: "+(obj1==obj2));
		System.out.println("언박싱 후 ==결과: "+(obj1.intValue()==obj2.intValue()));
		System.out.println("equals()의 결과 : "+obj1.equals(obj2));//원래 equals는 ==비교 인데
		System.out.println();												   // 다른 값이 나옴으로 재정의 되어있다
		...
		System.out.println("equals()의 결과 : "+obj3.equals(obj4));
		
		//굳이 예외 범위를 알고 있을 필요 없이 내부의 값을 비교할 대는 equals()메소드 사용
		}
}
