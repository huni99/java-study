...
public class KeyExample {
	public static void main(String[] args) {
		...
		//get()을할 때, hashCode()를 먼저 비교하고 그 다음 equlas()로 비교하기 때문
		//논리적으로는 동등하지만 물리적으로 동등하지 않아서 메모리 번지가 달라 hashCode값이 다르기때문
		//hashCode()도 재정의 필요하다
		//=>그래서 HashMap의 키로는 String 이 가장 많이 사용됨(String은 이미 hashCode()오 equals가 재정의 되어있음)
