...
//	좌석 정렬 후: [A1, A2, A3, B1, B2]
	...
	public static void main(String[] args) {
		...
		if(seats.contains(str)) {
			seats.set(seats.indexOf(str),str+"(예약)"); 
		
		}else {
			System.out.println(str+ "은 존재하지 않는 좌석입니다.");
		}
		...
		if(seats.contains(str)) {
			...
			System.out.println(str+" 좌석은 목록에 없습니다.");
		}
		System.out.println("좌석 삭제후 : "+seats);
