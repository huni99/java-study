...
//	- 축구공: 3000원
	...
	public static void main(String[] args) {
		...
		Set<Equipment> storagecopy = new HashSet<Equipment>();
		...
		storagecopy.addAll(storage1);
		
		System.out.println("*** 합집합 ***");
		storagecopy.addAll(storage2);
		Iterator<Equipment> iterator = storagecopy.iterator();
		while(iterator.hasNext()) {
			System.out.println(iterator.next());
		}
		System.out.println("*** 교집합 ***");
		storagecopy.retainAll(storage1);
		storagecopy.retainAll(storage2);
		iterator = storagecopy.iterator();
		while(iterator.hasNext()) {
			System.out.println(iterator.next());
		}
		System.out.println("*** 차집합 ***");
		storagecopy.addAll(storage1);
		storagecopy.removeAll(storage2);
		iterator = storagecopy.iterator();
		while(iterator.hasNext()) {
			System.out.println(iterator.next());
		}
