...
public class SutdentListExample {
	public static void main(String[] args) {
		// 사용자 정의 객체를 타입 파라미터로 사용할 경우 
		...
		//Student 처럼 사용자 정의 객체끼리 비교할 경우 비교 불가능
		//정렬 기준으로 어떤 값을 사용할지 별도로 구현해야 함
		//예: name을 기준으로 정렬할 겻인가, age를 기준으로 정렬할 것인가 
		
		//2가지 방법
		//Student 클래스가 Comparable 인터페이스를 구현하거나 
		//자바의 Comparator를 사용해서정렬 조건을 지정
